...
namespace SisCor.Controllers
{
    public class SindicatoController : Controller
    {
        ...
        public SindicatoController(SisCorContext context)
        {
            _context = context;
        }
